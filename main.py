...
from util.tool import load_model, load_svitmodel, load_motion_decoder
...
def get_args_parser():
    ...
    parser.add_argument('--memory_num_frames', default=4, type=int,
                        help="Number of query slots")
    ...
    parser.add_argument('--pretrained_decoder', default=None, help='resume from checkpoint')
    parser.add_argument('--pretrained_backbone', default=None, help='resume from checkpoint')
    parser.add_argument('--cache_mode', default=False, action='store_true', help='whether to cache images on memory')

    # end-to-end mot settings.
    parser.add_argument('--mot_path', default='/home/hzf/data/', type=str)
    ...
    parser.add_argument('--data_txt_path_train',
                        default='./datasets/data_path/joint.train', type=str,
...
def main(args):
    ...
    if args.pretrained_decoder is not None and args.pretrained_backbone is not None:
        model_without_ddp = load_model(model_without_ddp, args.pretrained_decoder)
        # model_without_ddp = load_motion_decoder(model_without_ddp, args.pretrained_decoder)
        # model_without_ddp = load_svitmodel(model_without_ddp, args.pretrained_backbone)
