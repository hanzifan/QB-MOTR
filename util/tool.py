...
def load_motion_decoder(model, model_path, optimizer=None, resume=False,
               lr=None, lr_step=None):
    start_epoch = 0
...
def load_svitmodel(model, model_path, optimizer=None, resume=False,
               lr=None, lr_step=None):
    start_epoch = 0
    checkpoint = torch.load(model_path)
    print(f'loaded {model_path}')
